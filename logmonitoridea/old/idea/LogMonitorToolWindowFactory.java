...
public class LogMonitorToolWindowFactory implements ToolWindowFactory {
    ...
    public LogMonitorToolWindowFactory(EntryStatusListener listener, LogService dao, ReaderScheduler scheduler, Serializer serializer, HomeResolver homeResolver) {
