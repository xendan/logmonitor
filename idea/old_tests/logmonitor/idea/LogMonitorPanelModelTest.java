...
public class LogMonitorPanelModelTest {
    ...
    public void test_isNodeUpdated() throws Exception {
        model.initTreeModel(new DefaultCallBack<DefaultTreeModel>() {
            ...
            public void onAnswer(DefaultTreeModel treeModel) {
                ...
                environment.setLastUpdate(new LocalDateTime(now));
                model.onEntriesAdded(environment, treeModel);
    ...
    public void setUp() {
        ...
        //nulll
        model = new LogMonitorPanelModel(null, new LogService(new HomeResolver(), ""), mock(Serializer.class), mock(EntryStatusListener.class), null);
